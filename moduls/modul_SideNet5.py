...
class SideNet5(nn.Module):
    ...
    def forward(self, x):
        ...
        x_11_1 = self.ZeroPad_21(x)
        x_11_1 = self.side_21(x_11_1)
        x_12_1 = self.ZeroPad_22(x)
        x_12_1 = self.side_22(x_12_1)
        x_13_1 = self.ZeroPad_23(x)
        x_13_1 = self.side_23(x_13_1)
        x_14_1 = self.ZeroPad_24(x)
        x_14_1 = self.side_24(x_14_1)
