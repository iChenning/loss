from utils.my_dataset import MyDataset, MyDataset10
...
if __name__ == "__main__":
    ...
    trainset = MyDataset10(txt_path=opt.read_data.train.file_path, transform=train_trans)
    ...
    optimizer2 = optim.SGD(byol.parameters(), lr=0.1, momentum=0.9, weight_decay=0.0003)
